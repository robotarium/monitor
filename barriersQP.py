...
def create_robust_barriers(max_num_obstacles = 30, max_num_robots = 30, d = 5, wheel_vel_limit = 25, base_length = 0.105, wheel_radius = 0.016,
    ...
    def robust_barriers(dxu, x, obstacles):
        ...
        # Flipped Ms to be able to perform desired matrix multplication 
        Ms[0, 0:2*num_robots:2] = Os[0, 0:num_robots]
